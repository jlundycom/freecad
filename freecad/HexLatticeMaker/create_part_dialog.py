...
class HexLatticeDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        # joint_width: solid-line width of the bridge zone at cut lines and
        #   joint tab width.  Defaults to perim_width at run-time if 0.
        self.joint_width_spin = _spin(0.0, 100.0, 0.0)
        self.joint_width_spin.setSpecialValueText("= Perimeter width")

        # tab_width: independent width of each individual joint tab along the
        #   cut face.  Separate from bridge width, so e.g. a 10 mm bridge with
        #   20 mm tabs is valid.  Defaults to joint_width at run-time if 0.
        self.tab_width_spin = _spin(0.0, 200.0, 0.0)
        self.tab_width_spin.setSpecialValueText("= Joint width")
        ...
        self._info_label = QtWidgets.QLabel(
            ...
            "<b>Joint width</b> sets the width (mm) of the solid bridge zone at "
            "each cut line (defaults to Perimeter width when 0). "
            "<b>Tab width</b> sets the width of each individual joint tab along "
            "the cut face — independent of Joint width (0 = same as Joint width). "
    ...
    * **Leg width** – side length of the square leg cross-section.
    ...
    def __init__(self, parent=None):
        ...
        self._info_label.setText(
            ...
            "<b>Tab width</b> sets the width of each individual joint tab along "
            "the cut face (0 = same as Joint width). "
